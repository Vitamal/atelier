...
if DJANGOENV == 'develop':  # Used for local development
    ...
    from atelier.project.develop.develop_settings import *
elif DJANGOENV == 'test':  # Used when running the Django tests locally
    from atelier.project.develop.test_settings import *
elif DJANGOENV == 'staging':  # Used in staging
    from atelier.project.production.staging_settings import *
elif DJANGOENV == 'production':  # Used in production
    from atelier.project.production.production_settings import *
else:
